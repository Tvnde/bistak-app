        ...
        <div className="card-content">
          <div className="card-above">
            <div className="product-img">
              <img src= {product && product.image!="" ? products.filter((product) => {return product._id == batch.product})[0].image : "https://bistakstore.s3.amazonaws.com/images/Bistak-Grocery-Logo_2.png"} alt="" />
            </div>
